...
public class AddNewIndividualSendersPOM {
	...
	public By senderButton=By.xpath("//span[text()='Senders' and @class='sidebar-text light_color colr font-fam']");
	...
	public By Title=By.xpath("//div/p[text()='View your individual sender clients']");
	public By searchBox=By.xpath("//input[@placeholder='Search']");
	public By newSenderButton=By.xpath("//button[text()='New Sender']");
	public By newSenderFirstName=By.xpath("//input[@id='first_name']");
	public By newSenderLastName=By.xpath("//input[@id='last_name']");
	public By newSenderPhoneNum=By.xpath("//div[contains(@class,'phone-container')]//input");
	public By newSenderProvince=By.xpath("//div[@id='province']");
	public By provinceState=By.xpath("//li[text()='Abruzzo']");
	public By newSenderCity=By.xpath("//div[@id='city']");
	public By newSenderCityName=By.xpath("//li[text()='Avezzano']");
	public By newSenderDOB=By.xpath("//input[@placeholder='MM/DD/YYYY']");
	public By newSenderDOBChooseDateButton=By.xpath("//button[@aria-label='Choose date']");
	public By newSenderDOBDate=By.xpath("(//button[@role='gridcell'])[1]");
	public By newSenderMail=By.xpath("//input[@id='email']");
	public By newSenderAddress=By.xpath("//textarea[@id='address']");
	public By newSenderNextButton=By.xpath("//button[text()='Next']");
	public By newSenderCacelButton=By.xpath("//button[text()='Cancel']");
	public By newSenderFinanceType=By.xpath("//div[@id='type']");
	public By paypalFinance=By.xpath("//li[text()='PAYPAL']");
	public By newSenderPaypalMailBox=By.xpath("//input[@id='email']");
	public By venmoFinance=By.xpath("//li[text()='VENMO']");
	public By newSenderVenmoId=By.xpath("//input[@id='venmo_id']");
	...
	public By balanceBox=By.xpath("//div[text()='Balance']");
