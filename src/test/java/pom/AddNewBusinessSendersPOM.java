...
public class AddNewBusinessSendersPOM {
	...
	public By businessSenderClientPage=By.xpath("//div/h3[text()='Business Senders']");
	public By Title=By.xpath("//div/p[text()='View your business sender clients']");
	public By searchBox=By.xpath("//input[@placeholder='Search']");
	public By newSenderButton=By.xpath("//button[text()='New Sender']");
	public By newSenderBusinessName=By.xpath("//input[@id='business_name']");
